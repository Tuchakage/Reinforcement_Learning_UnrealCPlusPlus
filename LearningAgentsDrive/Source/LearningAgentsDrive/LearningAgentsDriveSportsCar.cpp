...
#include "LearningAgentsDriveSportsCar.h"
#include "LearningAgentsDriveSportsWheelFront.h"
#include "LearningAgentsDriveSportsWheelRear.h"
...
ALearningAgentsDriveSportsCar::ALearningAgentsDriveSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = ULearningAgentsDriveSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = ULearningAgentsDriveSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = ULearningAgentsDriveSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = ULearningAgentsDriveSportsWheelRear::StaticClass();
