...
#include "LearningAgentsDriveOffroadCar.h"
#include "LearningAgentsDriveOffroadWheelFront.h"
#include "LearningAgentsDriveOffroadWheelRear.h"
...
ALearningAgentsDriveOffroadCar::ALearningAgentsDriveOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = ULearningAgentsDriveOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = ULearningAgentsDriveOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = ULearningAgentsDriveOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = ULearningAgentsDriveOffroadWheelRear::StaticClass();
