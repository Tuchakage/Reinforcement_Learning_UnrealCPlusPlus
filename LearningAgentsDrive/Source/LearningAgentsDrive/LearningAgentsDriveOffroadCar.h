...
#include "LearningAgentsDriveOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class LEARNINGAGENTSDRIVE_API ALearningAgentsDriveOffroadCar : public ALearningAgentsDrivePawn
{
	GENERATED_BODY()
...
public:
	...
	ALearningAgentsDriveOffroadCar();
};
